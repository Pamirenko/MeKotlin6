...
import com.example.mekotlin6.R
import com.example.mekotlin6.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createDialog() {
        AlertDialog.Builder(this).setTitle(getString(R.string.permision_read))
            ...
            }.setNegativeButton(getString(R.string.no_i_wanna_stay)) { _, _ ->
            }.show()
    }
}